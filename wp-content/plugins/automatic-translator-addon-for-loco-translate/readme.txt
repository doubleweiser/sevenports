...
This addon supports Yandex Translate API for free users and Yandex, Google & Microsoft(Coming soon...) Translate API for premium users.
...
= Special THANKS!: =
Special thanks to famous **[Loco Translate](https://wordpress.org/plugins/loco-translate/)** plugin authors for creating an awesome plugin for translations and Yandex for providing translate API.
